...
| `Scheduled` | category | Reservations: hotels, transport, salons, cinemas, and other bookings. Overlap with `Receipt` is acceptable. |
...
| receipt 0.60, scheduled 0.30, other 0.10 | `Receipt`, `Scheduled` |
...
```json
{
  ...
  "category": {
    ...
    "options": {
      ...
      "scheduled": { "label": "Scheduled", "criteria": { "...": "..." } },
...
- Name of the `Action` label (`Action` or `Respond`).
